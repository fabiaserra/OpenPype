...
class IntegrateShotgridVersion(pyblish.api.InstancePlugin):
    ...
    def process(self, instance):
        ...
        ### Starts Alkemy-X Override ###
        frame_start = instance.data.get("frameStart", context.data.get("frameStart", 0))
        frame_end = instance.data.get("frameEnd", context.data.get("frameEnd", 0))
        handle_start = instance.data.get("handleStart", context.data.get("handleStart", 0))
        handle_end = instance.data.get("handleEnd", context.data.get("handleEnd", 0))
